...
class AuthTacacsAction(NSBaseResource):
    ...
    def get_all(nitro):
        ...
        __json_tacacsactions = nitro.get(__url).get_response_field(
            AuthTacacsAction.get_resourcetype())
        __tacacsactions = []
    ...
    def add(nitro, tacacsaction):
        ...
        __tacacsaction.set_defaultauthenticationgroup(
            tacacsaction.get_defaultauthenticationgroup())
