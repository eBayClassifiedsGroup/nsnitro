...
class NSLBVServerServiceGroupBinding(NSBaseResource):
    ...
    def get(nitro, vserver_servicegroup_binding):
        ...
        """
        __url = nitro.get_url() + NSLBVServerServiceGroupBinding.get_resourcetype() + \
            "/" + vserver_servicegroup_binding.get_name()
        __json_services = nitro.get(__url).get_response_field(
            NSLBVServerServiceGroupBinding.get_resourcetype())
        __services = []
    ...
    def add(nitro, vserver_servicegroup_binding):
        ...
        __vserver_servicegroup_binding.set_name(
            vserver_servicegroup_binding.get_name())
        __vserver_servicegroup_binding.set_servicename(
            vserver_servicegroup_binding.get_servicename())
        __vserver_servicegroup_binding.set_weight(
            vserver_servicegroup_binding.get_weight())
        __vserver_servicegroup_binding.set_servicegroupname(
            vserver_servicegroup_binding.get_servicegroupname())
