...
class NSRewritePolicyCSVServerBinding(NSBaseResource):
    ...
    def get(nitro, rewritepolicy_csvserver_binding):
        ...
        """
        __url = nitro.get_url() + NSRewritePolicyCSVServerBinding.get_resourcetype() + \
            "/" + rewritepolicy_csvserver_binding.get_name()
        __json_resources = nitro.get(__url).get_response_field(
            NSRewritePolicyCSVServerBinding.get_resourcetype())
        __resources = []
