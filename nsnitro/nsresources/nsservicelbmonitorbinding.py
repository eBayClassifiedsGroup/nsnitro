...
class NSServiceLBMonitorBinding(NSBaseResource):
    ...
    def get(nitro, servicelbmonitorbinding):
        ...
        """
        __url = nitro.get_url() + NSServiceLBMonitorBinding.get_resourcetype() + \
            "/" + servicelbmonitorbinding.get_name()
        __json_servicelbmonitorbindings = nitro.get(__url).get_response_field(
            NSServiceLBMonitorBinding.get_resourcetype())
        __servicelbmonitorbindings = []
        for json_servicelbmonitorbinding in __json_servicelbmonitorbindings:
            __servicelbmonitorbindings.append(
                NSServiceLBMonitorBinding(json_servicelbmonitorbinding))
