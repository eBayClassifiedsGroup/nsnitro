...
class NSResponderPolicyLabel(NSBaseResource):
    ...
    def get(nitro, responderpolicylabel):
        ...
        __responderpolicylabel.set_labelname(
            responderpolicylabel.get_labelname())
    ...
    def get_all(nitro):
        ...
        __json_cspolicies = nitro.get(__url).get_response_field(
            NSResponderPolicyLabel.get_resourcetype())
        __responderpolicies = []
        for json_responderpolicylabel in __json_cspolicies:
            __responderpolicies.append(
                NSResponderPolicyLabel(json_responderpolicylabel))
    ...
    def add(nitro, responderpolicylabel):
        ...
        __responderpolicylabel.set_labelname(
            responderpolicylabel.get_labelname())
        __responderpolicylabel.set_policylabeltype(
            responderpolicylabel.get_policylabeltype())
        __responderpolicylabel.set_priority(
            responderpolicylabel.get_priority())
