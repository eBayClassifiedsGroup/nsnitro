...
class NSResponderPolicyLabelBinding(NSBaseResource):
    ...
    def get(nitro, responderpolicylabel_binding):
        ...
        """
        __url = nitro.get_url() + NSResponderPolicyLabelBinding.get_resourcetype() + \
            "/" + responderpolicylabel_binding.get_labelname()
        __json_resources = nitro.get(__url).get_response_field(
            NSResponderPolicyLabelBinding.get_resourcetype())
        __resources = []
    ...
    def add(nitro, responderpolicylabel_binding):
        ...
        __responderpolicylabel_binding.set_labelname(
            responderpolicylabel_binding.get_labelname())
        __responderpolicylabel_binding.set_policyname(
            responderpolicylabel_binding.get_policyname())
        __responderpolicylabel_binding.set_priority(
            responderpolicylabel_binding.get_priority())
        __responderpolicylabel_binding.set_gotopriorityexpression(
            responderpolicylabel_binding.get_gotopriorityexpression())
        __responderpolicylabel_binding.set_flags(
            responderpolicylabel_binding.get_flags())
        __responderpolicylabel_binding.set_labeltype(
            responderpolicylabel_binding.get_labeltype())
        __responderpolicylabel_binding.set_invoke_labelname(
            responderpolicylabel_binding.get_invoke_labelname())
    ...
    def delete(nitro, responderpolicylabel_binding):
        ...
        __responderpolicylabel_binding.set_policyname(
            responderpolicylabel_binding.get_policyname())
        nsresponse = __responderpolicylabel_binding.delete_resource(
            nitro, __name)
        return nsresponse
