...
# Configuration for Load Balancing Virtual Server resource.
    ...
    def add(nitro, lbvserver):
        ...
        __lbvserver.set_backuppersistencetimeout(
            lbvserver.get_backuppersistencetimeout())
        ...
        __lbvserver.set_sopersistencetimeout(
            lbvserver.get_sopersistencetimeout())
        __lbvserver.set_sothreshold(lbvserver.get_sothreshold())
        __lbvserver.set_redirectportrewrite(
            lbvserver.get_redirectportrewrite())
        __lbvserver.set_downstateflush(lbvserver.get_downstateflush())
        __lbvserver.set_backupvserver(lbvserver.get_backupvserver())
        __lbvserver.set_disableprimaryondown(
            lbvserver.get_disableprimaryondown())
        __lbvserver.set_insertvserveripport(
            lbvserver.get_insertvserveripport())
