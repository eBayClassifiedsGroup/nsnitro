...
class NSCSVServerCSPolicyBinding(NSBaseResource):
    ...
    def get(nitro, csvserver_cspolicy_binding):
        ...
        __json_resources = nitro.get(__url).get_response_field(
            NSCSVServerCSPolicyBinding.get_resourcetype())
        __resources = []
    ...
    def add(nitro, csvserver_cspolicy_binding):
        ...
        __csvserver_cspolicy_binding.set_name(
            csvserver_cspolicy_binding.get_name())
        __csvserver_cspolicy_binding.set_targetvserver(
            csvserver_cspolicy_binding.get_targetvserver())
        __csvserver_cspolicy_binding.set_policyname(
            csvserver_cspolicy_binding.get_policyname())
        __csvserver_cspolicy_binding.set_priority(
            csvserver_cspolicy_binding.get_priority())
        __csvserver_cspolicy_binding.set_gotopriorityexpression(
            csvserver_cspolicy_binding.get_gotopriorityexpression())
        __csvserver_cspolicy_binding.set_bindpoint(
            csvserver_cspolicy_binding.get_bindpoint())
        __csvserver_cspolicy_binding.set_invoke(
            csvserver_cspolicy_binding.get_invoke())
        __csvserver_cspolicy_binding.set_labeltype(
            csvserver_cspolicy_binding.get_labeltype())
        __csvserver_cspolicy_binding.set_labelname(
            csvserver_cspolicy_binding.get_labelname())
