...
class NSIPTunnel(NSBaseResource):
    ...
    def delete(nitro, iptunnel):
        __iptunnel = NSIPTunnel()
        __iptunnel.set_name(iptunnel.get_name())
        nsresponse = __iptunnel.delete_resource(
            nitro, object_name=__iptunnel.get_name())
        return nsresponse
    ...
    def get_all(nitro):
        ...
        __json_iptunnels = nitro.get(__url).get_response_field(
            NSIPTunnel.get_resourcetype())
        __iptunnels = []
