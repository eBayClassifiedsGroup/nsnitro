...
class NSRewriteAction(NSBaseResource):
    ...
    def get_all(nitro):
        ...
        __json_cspolicies = nitro.get(__url).get_response_field(
            NSRewriteAction.get_resourcetype())
        __rewritepolicies = []
    ...
    def add(nitro, rewriteaction):
        ...
        __rewriteaction.set_stringbuilderexpr(
            rewriteaction.get_stringbuilderexpr())
        __rewriteaction.set_pattern(rewriteaction.get_pattern())
        __rewriteaction.set_search(rewriteaction.get_search())
        __rewriteaction.set_allow_unsafe_pi(
            rewriteaction.get_allow_unsafe_pi())
    ...
    def update(nitro, rewriteaction):
        ...
        __rewriteaction.set_allow_unsafe_pi(
            rewriteaction.get_allow_unsafe_pi())
        __rewriteaction.set_allow_unsafe_pi1(
            rewriteaction.get_allow_unsafe_pi1())
        __rewriteaction.set_refinesearch(rewriteaction.get_refinesearch())
        __rewriteaction.set_comment(rewriteaction.get_comment())
