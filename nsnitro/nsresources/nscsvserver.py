...
# Configuration for Content Switching Virtual Server resource.
    ...
    def get_all(nitro):
        ...
        __json_csvservers = nitro.get(__url).get_response_field(
            NSCSVServer.get_resourcetype())
        __csvservers = []
    ...
    def add(nitro, csvserver):
        ...
        __csvserver.set_sopersistencetimeout(
            csvserver.get_sopersistencetimeout())
        __csvserver.set_sothreshold(csvserver.get_sothreshold())
        __csvserver.set_redirectportrewrite(
            csvserver.get_redirectportrewrite())
        __csvserver.set_downstateflush(csvserver.get_downstateflush())
        __csvserver.set_backupvserver(csvserver.get_backupvserver())
        __csvserver.set_disableprimaryondown(
            csvserver.get_disableprimaryondown())
        __csvserver.set_insertvserveripport(
            csvserver.get_insertvserveripport())
