...
class NSSystemCMDPolicy(NSBaseResource):
    ...
    def delete(nitro, systemcmdpolicy):
        __systemcmdpolicy = NSSystemCMDPolicy()
        __systemcmdpolicy.set_policyname(systemcmdpolicy.get_policyname())
        nsresponse = __systemcmdpolicy.delete_resource(
            nitro, object_name=__systemcmdpolicy.get_policyname())
        return nsresponse
    ...
    def get_all(nitro):
        ...
        __json_systemcmdpolicies = nitro.get(__url).get_response_field(
            NSSystemCMDPolicy.get_resourcetype())
        __systemcmdpolicies = []
