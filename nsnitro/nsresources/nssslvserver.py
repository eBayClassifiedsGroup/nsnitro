...
class NSSSLVServer(NSBaseResource):
    ...
    def get_all(nitro):
        ...
        __json_sslvservers = nitro.get(__url).get_response_field(
            NSSSLVServer.get_resourcetype())
        __sslvservers = []
    ...
    def update(nitro, sslvserver):
        ...
        __sslvserver.set_redirectportrewrite(
            sslvserver.get_redirectportrewrite())
