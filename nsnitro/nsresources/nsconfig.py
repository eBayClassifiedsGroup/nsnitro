...
class NSConfig(NSBaseResource):
    ...
    def update(nitro, config):
        ...
        __config.set_exclusivequotamaxclient(
            config.get_exclusivequotamaxclient())
        __config.set_grantquotaspillover(config.get_grantquotaspillover())
        __config.set_exclusivequotaspillover(
            config.get_exclusivequotaspillover())
    ...
    def get_all(nitro):
        ...
        __json_configs = nitro.get(__url).get_response_field(
            NSConfig.get_resourcetype())
        __configs = []
