...
class NSCSVServerResponderPolicyBinding(NSBaseResource):
    ...
    def get(nitro, csvserver_responderpolicy_binding):
        ...
        for json_resource in __json_resources:
            __resources.append(
                NSCSVServerResponderPolicyBinding(json_resource))
        return __resources
    ...
    def add(nitro, csvserver_responderpolicy_binding):
        ...
        __csvserver_responderpolicy_binding.set_name(
            csvserver_responderpolicy_binding.get_name())
        __csvserver_responderpolicy_binding.set_policyname(
            csvserver_responderpolicy_binding.get_policyname())
        __csvserver_responderpolicy_binding.set_priority(
            csvserver_responderpolicy_binding.get_priority())
        __csvserver_responderpolicy_binding.set_gotopriorityexpression(
            csvserver_responderpolicy_binding.get_gotopriorityexpression())
        __csvserver_responderpolicy_binding.set_bindpoint(
            csvserver_responderpolicy_binding.get_bindpoint())
        __csvserver_responderpolicy_binding.set_invoke(
            csvserver_responderpolicy_binding.get_invoke())
        __csvserver_responderpolicy_binding.set_labeltype(
            csvserver_responderpolicy_binding.get_labeltype())
        __csvserver_responderpolicy_binding.set_labelname(
            csvserver_responderpolicy_binding.get_labelname())
