...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--lbip', metavar='IP', required=True, help='lb ip address')
    parser.add_argument(
        '--user', metavar='USERNAME', default='api_user', help='lb username')
    parser.add_argument(
        '--password', metavar='PASSWORD', default='api_user', help='lb password')

    parser.add_argument(
        '--addlbvserver', metavar='LBVSERVERNAME', help='enable lb vserver')
    parser.add_argument(
        '--enablelbvserver', metavar='LBVSERVERNAME', help='enable lb vserver')
    parser.add_argument(
        '--disablelbvserver', metavar='LBVSERVERNAME', help='disable lb vserver')
    parser.add_argument('--renamelbvserver', metavar=('LBVSERVERNAME',
                        'NEWNAME'), nargs=2, help='rename lb vserver from NAME to NEWNAME')

    parser.add_argument(
        '--getlbvserver', metavar='LBVSERVERNAME', help='show lb vserver')
    parser.add_argument(
        '--getlbvserverslist', action='store_true', help='show lb vservers list')
    parser.add_argument(
        '--getlbvserverstatus', metavar='LBVSERVERNAME', help='show lb vserver status')
    parser.add_argument('--getlbvserverstatusfull', metavar='LBVSERVERNAME',
                        help='show lb vserver status with bound services')
    parser.add_argument(
        '--getlbvserversstatus', action='store_true', help='show lb vservers status')

    parser.add_argument(
        '--enablecsvserver', metavar='CSVSERVERNAME', help='enable cs vserver')
    parser.add_argument(
        '--disablecsvserver', metavar='CSVSERVERNAME', help='disable cs vserver')
    parser.add_argument('--renamecsvserver', metavar=('CSVSERVERNAME',
                        'NEWNAME'), nargs=2, help='rename cs vserver from NAME to NEWNAME')
    parser.add_argument(
        '--getcsvserver', metavar='CSVSERVERNAME', help='show cs vserver')
    parser.add_argument(
        '--getcsvserverslist', action='store_true', help='show cs vservers list')
    parser.add_argument(
        '--getcsvserverstatus', metavar='CSVSERVERNAME', help='show cs vserver status')
    parser.add_argument(
        '--getcsvserversstatus', action='store_true', help='show cs vservers status')

    parser.add_argument('--addservice', metavar=('SERVICENAME', 'LBVSERVERNAME'), nargs=2,
                        help='add service SERVICENAME to lb vserver LBVSERVERNAME (ip and port also requires)')
    parser.add_argument(
        '--enableservice', metavar='SERVICENAME', help='enable service')
    parser.add_argument(
        '--disableservice', metavar='SERVICENAME', help='disable service')
    parser.add_argument('--renameservice', metavar=('NAME', 'NEWNAME'),
                        nargs=2, help='rename service from NAME to NEWNAME')

    parser.add_argument(
        '--getservice', metavar='SERVICENAME', help='show service')
    parser.add_argument(
        '--getservicestatus', metavar='SERVICENAME', help='show service status')
    parser.add_argument(
        '--getserviceslist', action='store_true', help='show services list')
    parser.add_argument(
        '--getservicesstatus', action='store_true', help='show services status')
    parser.add_argument('--bindservice', metavar=('SERVICENAME', 'LBVSERVERNAME'),
                        nargs=2, help='bind service SERVICENAME to lb vserver LBVSERVERNAME ')

    parser.add_argument(
        '--getserver', metavar='SERVERNAME', help='show server')
    parser.add_argument(
        '--getserverslist', action='store_true', help='show servers list')
    parser.add_argument(
        '--getserversstatus', action='store_true', help='show servers status')
    parser.add_argument(
        '--enableserver', metavar='SERVERNAME', help='enable server')
    parser.add_argument(
        '--disableserver', metavar='SERVERNAME', help='disable server')
    parser.add_argument('--renameserver', metavar=('NAME', 'NEWNAME'),
                        nargs=2, help='rename server from NAME to NEWNAME')

    parser.add_argument(
        '--saveconfig', action='store_true', help='save loadbalancer config')

    parser.add_argument('--getprimarylb', action='store_true',
                        help='If you netscaler is in a cluster show the node that is primary')
    ...
    parser.add_argument('--servicetype', metavar='SERVICETYPE',
                        choices=['TCP', 'HTTP'], default='TCP', help='Service type')
    parser.add_argument(
        '--clttimeout', metavar='CLTTIMEOUT', default=9000, help='Clt timeout')
    parser.add_argument(
        '--svrtimeout', metavar='SRVTIMEOUT', default=9000, help='service timeout')
    parser.add_argument(
        '--persistencetype', metavar='PERSISTENCETYPE', default='NONE', help='persistence type')
    parser.add_argument('--bindingweight', metavar='BINDINGWIIGHT',
                        default=40, help='weight parameter for binding service')

    # ACL related arguments
    parser.add_argument('--getacl', metavar='ACLNAME', help='show acl')
    parser.add_argument(
        '--getaclslist', action='store_true', help='show acl list')
    parser.add_argument('--addacl', metavar='ACLNAME', help='add acl')
    parser.add_argument('--delacl', metavar='ACLNAME', help='del acl')
    parser.add_argument(
        '--applyacls', action='store_true', help='apply acls to kernel')
    parser.add_argument('--clearacls', action='store_true', help='clear acls')
    parser.add_argument(
        '--renumberacls', action='store_true', help='renumber acls')

    parser.add_argument('--bindservertoservicegroup',
                        action='store_true', help='bind a server to a service group')
    parser.add_argument('--unbindserverfromservicegroup',
                        action='store_true', help='bind a server to a service group')
    parser.add_argument(
        '--servername', action='store', help='server object to manipulate')
    parser.add_argument(
        '--servicegroupname', action='store', help='service group object to manipulate')
